...
function GClef({ style }: { style: React.CSSProperties }) {
  return (
    //       <!-- Created with Inkscape (http://www.inkscape.org/) -->
    <svg id="svg1938" width="44" height="75" version="1.0" style={style}>
      <defs id="defs1941" />
      <g id="g1876" transform="matrix(1.010278,0,0,1.010278,-24.38602,-0.986803)">
        <path
          id="path1947"
